...
<body>
    ...
    <div id="div">
        ...
        <center>
            <br><br><br>
            <img src="img/img_titulos/titulo_prod_pesquisados.png" height="35px" width="357px">
            <br><br>
            ...
            <?php
                ...
                if($_POST['tipo_pesquisa']=='categoria'){
                    ...
                    if($encontrados>0){
                        ...
                        $sql="SELECT * FROM produto WHERE idcategoria=".$linha['idcategoria'] ."AND excluido=false";
                    }
                }    
                else $sql="SELECT * FROM produto WHERE $_POST[tipo_pesquisa] ILIKE '%$_POST[pesquisa]%' AND excluido=false ORDER BY idproduto;";
                ...
                if($encontrados>0)
                {
                    for($i=0; $i<$encontrados; $i++)
                    {
                        ...
                        echo "<br><center><a class='btn-user' href='altera_prod_lista.php?idproduto=".$dados['idproduto']."'>Alterar</a>&nbsp;&nbsp;<a class='btn-user' href='exclui_prod_lista.php?idproduto=".$dados['idproduto']."'>Excluir</a></center><br>";
