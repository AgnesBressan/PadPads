...
<body>
    ...
    ?>
        ...
        ?>
            <h1>Conta do Cliente '<?php echo $linha['nome'] ?>'</h1>
            <div id='campos'>
                ...
                <p style="width: 520px;">
                    <font size="3">
                        <font style="arial"><input type="text" name="id_cliente"
                ...
                <p style="width: 520px;">
                    <font size="3">
                        <font style="arial">
                            ...
                            <input type="text" name="complemento" value="<?php echo $linha['complemento']; ?>" readonly>
                        </font>
                    </font>
                </p>
                <br><label class="hora2">
                ...
                <p style="width: 520px;">
                    <font size="3">
                        <font style="arial"><input type="text" name="cidade" value="<?php echo $linha['cidade']; ?>"
                                readonly>&nbsp;<input type="text" name="estado" value="<?php echo $linha['estado']; ?>"
                                readonly></font>
                    </font>
                </p>
                <br><label class="hora2">
            ...
            <?php echo"<a href='exclui_user.php?id=".$linha['idcliente']."' class='btn-user'>Desativar Conta</a><br><br>" ?>
            <a href="dados.php" class="btn-user">Voltar para lista</a><br><br>
        </center>
