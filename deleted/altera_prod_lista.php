...
<body>
    ...
    ?>
            <font face="arial">
                ...
                <form action="grava_prod_alterado.php" method="post">
                    ...
                    <input class="text_box" type="text" size="15" name="nome" value="<?php echo $linha['nome']; ?>" />
                    ...
                    <input class="text_box" type="text" name="modelo" size="13" value="<?php echo $linha['modelo']; ?>" />
                    ...
                    <input class="text_box" type="text" size="8" name="cor" value="<?php echo $linha['cor']; ?>" />
                    ...
                    <input class="text_box" type="number" name="preco" max="10000" min="0" step=".01" value="<?php echo $linha['preco']; ?>" />
                    ...
                    //tá em php pq ele vai percorrendo a tabela pra procurar as categorias disponiveis
                            ...
                            for($i=1;$i<=$num;$i++){
                                $l=pg_fetch_array($r);
                                echo "<option value=".$l['idcategoria'].">".$l['nome_categoria']."</option>";
                            }
                        ?>
                    ...
                    <input class="text_box" type="number" name="qtde" style="width:135px" min="0" value="<?php echo $linha['qtde'] ?>"/>
                    <br> 
    ...
    <div align="center">
        <?php
                    echo "<br><a href='altera_exclui_prod.php'><button style='background: purple; border-radius: 4px; padding: 8px; cursor: pointer; color: black; border: groove; font-size: 18px; font-family: arial;'> Voltar para a alteração </button></a>"; 
        ?>
        <br><br>
