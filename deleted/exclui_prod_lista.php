...
<body>
            ...
            <font face="arial">
                ...
                <form action="exclui_prod_logica.php" method="post">
                    ...
                    <div align="left">
                        ...
                        <input class="text_box" type="text" size="15" name="nome" value="<?php echo $linha[1]; ?>"
                            readonly>
                        ...
                        <input class="text_box" type="text" name="modelo" size="13" value="<?php echo $linha[2]; ?>"
                            readonly>
                        ...
                        <input class="text_box" type="text" size="8" name="cor" value="<?php echo $linha[3]; ?>"
                            readonly>
                        ...
                        <input class="text_box" type="number" name="preco" max="10000" min="0" step=".01"
                    ...
                    <div align="left">
                        ...
                        <input class="text_box" type="number" name="estoque" style="width:135px" min="0"
                        ...
                        <input class="text_box" type="text" size="10" name="categoria"
                            value="<?php echo getCategoria($linha[0]); ?>" readonly>
                        <br>
    ...
    <div align="center">
        ...
        <a href='altera_exclui_prod.php'><button type="submit" value="limpar" name="enviar"
                class="btn_baixo btn_login1">Voltar para a home</button></a>
        <br><br>
