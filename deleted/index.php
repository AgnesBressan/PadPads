            ...
            <div style="padding-top: 17px; padding-left:15px;">
                ...
                <a><a href="carrinho.php"><img src="img/carrinho.png" width="50px" height="50px"></a>
                    ...
                    <?php
                            ...
                            {
                                ?>
                    <a style="cursor:pointer" onclick="mudaEstado('logout_links')"><img src='img/usuario.png'
                            width='50px' height='50px'></a>
                    <?php
                                echo "<div id='logout_links' style='display:none'>
                                    <div class='logout'>
                                        <a style='border-top:1px solid' href='area_user.php'>Área do Usuário</a>
                                        <a style='border-top:1px solid; border-bottom:1px solid' href='logout.php'>Logout</a>
                                    </div>
                                </div>";
                            }
            ...
            <div class="slider">
                ...
                <div class="slides">
                    ...
                    <div class="slide primeiro">
                        ...
                        <img src="img/gamer_estamp5.png" alt="">
                    ...
                    <div class="slide">
                        ...
                        <img src="img/gamer_estamp4.png" alt="">

                    </div>

                    <div class="slide">

                        <img src="img/gamer_estamp2.png" alt="">

                    </div>

                    <div class="slide">

                        <img src="img/gamer_estamp3.png" alt="">
