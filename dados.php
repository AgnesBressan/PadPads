...
<body>
    ...
    ?>
        ...
        <center>
            <br><br>
            <img src="img/img_titulos/titulo_dados_clientes.png" height="35px" width="310px">
            <br>
        ...
        <div class='container'>
            <?php
                ...
                if(isset($_POST['tipo_pesquisa'])){
                    ...
                    {
                    $sql="SELECT * FROM cliente WHERE $_POST[tipo_pesquisa] ILIKE '%$_POST[pesquisa]%' AND excluido=false ORDER BY idcliente;";
                    ...
                    $busca = "SELECT * FROM cliente WHERE excluido=false ORDER BY idcliente";
                    ...
                    while ($dados = pg_fetch_array($limite)) 
                    {
                        echo "<div class='sub'>
                            ...
                            <b>Email:</b> ".$dados['email']."<br><br><center><a class='btn-user' href='todos_dados.php?id=".$dados['idcliente']."'>Ver mais...</a></center><br>";
