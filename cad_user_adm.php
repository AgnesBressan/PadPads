    ...
    <center>
        ...
        <div id="div">
            ...
            <font face="arial">
                ...
                <center>
                    <br><br>
                    <img src="img/img_titulos/titulo_cadastro_adm.png" height="35px">
                    <br><br>
                </center>
                    ...
                    <div align="left">
                        ...
                        <div class="juntando">
                            <section>
                                ...
                                <input class="text_box" id="email" type="email" size="13" name="email" onkeyup="document.getElementById('email').style.border='0';
                                         document.getElementById('email').style.borderBottom ='2px solid lightgrey'" required>
                            ...
                            <section style="margin-left: -15px">
                                ...
                                <input class="text_box" type="password" name="senha" id="senhaForca" onkeyup="validarForca()" size="14" required>
                        ...
                        <section align="left">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="password" id="confirmasenha" placeholder="Confirma a Senha *" size="14" onkeyup="confirmarSenha()" required>
                            <span class="mostrar-erro">
