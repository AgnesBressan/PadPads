...
<body>
    ...
    <div id="div">
        ...
        <center>
            <br><br>
            <img src="img/img_titulos/titulo_compras_realizadas.png" height="35px" width="325px">
            <br><br>
        ...
        <center>
            <?php
                    include "conexao.php";
                    $id=$_SESSION['id'];
                    $sql="SELECT * FROM compra ORDER BY idcompra DESC"; //procurar todas as compras feitas pelo user
